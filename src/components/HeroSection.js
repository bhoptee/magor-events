...
export default class HeroSection extends React.Component {
    render() {
        ...
        return (
            <section className={classNames('section', 'hero', {'bg-image': _.get(section, 'has_background', null) && _.get(background, 'background_image', null), 'blue-inverse bg-blue': _.get(section, 'has_background', null) && (background_color === 'blue'), 'yellow-inverse bg-yellow': _.get(section, 'has_background', null) && (background_color === 'yellow'),'red-inverse bg-red': _.get(section, 'has_background', null) && (background_color === 'red'), 'section--padding': _.get(section, 'has_background', null) || _.get(section, 'image', null)})}>
